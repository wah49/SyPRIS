...
def syp_pkg_tester(cof_file, scaff_file):
    ...
    cof.generate_inverse_rot_ensemble(std_periodicity=1, lasa='CB', my_rotlib='./rotlib_cont.txt')
    for k,v in cof.bb_rot_ensemble.iteritems():
        v.write_to_file(str(k)+'.pdb')
